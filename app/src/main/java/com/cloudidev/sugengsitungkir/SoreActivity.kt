...
import com.cloudidev.sugengsitungkir.view.ViewPagerAdapterPT

class SoreActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPager = findViewById<View>(R.id.sore) as ViewPager

        adapter = ViewPagerAdapterPT(this@SoreActivity, judul, keteranganarab, keteranganindo)
